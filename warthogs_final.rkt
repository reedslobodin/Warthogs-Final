...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname run_this) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
;--------------------------------------------------------------------------------------------------
;an "x" is a number representing the X coordinate of image
...
;a "y" is a number representing the Y coordinate of image
...
;bg-image-dots takes in a list-of-numbers ("LIST")
;that is either '() or (cons Number List-of-numbers)
;draws a row of 8 evenly spaced dots based on x coordinate
;and y coordinate specified by first LIST element +1
...
;ws is a list of booleans specified by worldstate
;n1 is a number that corresponds with the first position in the lists
;n2 is a number that corresponds with the second position in the lists
...
;x is a number representing the first position in the lists
;y is a number representing the second position in the lists
...
;a counter is a number that tracks number of iterations
;a lob is a list of booleans
...
;number --> number  
  ...
  (cond [(= counter 0) 72]
        ...
        [(= counter 7) 60]
        [(= counter 8) 59]))
;a lon is a list of notes
;a nl is a number representing note duration
;a note-place is a number representing location of note in list of notes
...
;A midi is a number repesenting a midi note number
